...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spJumlah = (Spinner) findViewById(R.id.spinnerJmlAnak);
        ...
        llAnak = (LinearLayout) findViewById(R.id.llJmlAnak);
        tvHasil = (TextView) findViewById(R.id.tvHasil);

        findViewById(R.id.btnProses).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void doProcess() {
        ...
        for (int i = 1; i <= jumlah; i++) {
            ...
            EditText etNama = (EditText) llNow.findViewById(R.id.etNama);
            EditText etUmur = (EditText) llNow.findViewById(R.id.etUmur);
